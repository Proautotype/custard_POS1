...
- **`com.pos.base`**: Reusable components and base classes for all features
...
- **`com.pos.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `com.pos` (e.g., `com.pos.myfeature`)
